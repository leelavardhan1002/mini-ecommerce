  ...
  return (
    <div className="bg-gray-300 h-screen w-screen flex justify-center items-center">
      <div className="container flex h-fit">
        <div className="container rounded-l-lg w-1/2 hidden bg-PRIMARY md:flex md:items-center md:justify-center">
          <div className="flex justify-center mt-10">
            <Image src={SigninImage} alt="SignInImage" height={300} priority />
          </div>
        </div>
        <div className="container py-4 rounded-lg w-full md:w-1/2 bg-SECONDARY flex items-center justify-center">
          <div className="w-3/4">
            <Button
              Icon={IoArrowBack}
